...
function sendRegisterDataToFirebase() {
    ...
    var opalStart2 = $('#opalStart2').is(":checked");
    ...
    if (opalStart2 === true) campsPicked++;
    ...
    if (inputAllRight) {
        ...
        if (opalStart === true) dbName = "start2020"
        if (opalStart2 === true) dbName = "start2020-2"
        if (opalPro === true) dbName = "pro2020"
